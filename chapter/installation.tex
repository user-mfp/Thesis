...
\end{figure}
Y-values have a similar spread. The range from -1155mm to -115mm. Thus, the range on the Y-axis is 1040mm. The spread os more flat, though. Thus, there are 54 values within an range of 347mm and the Y-values are far from sufficient accuracy.
\begin{figure}[H]%
...
\begin{figure}[H]%
\includegraphics[width=\columnwidth]{../pics/blank.eps}%
\caption{Depth image through the glass panels of the Hassleben-showcase.}%
...
\begin{figure}[H]%
\includegraphics[width=\columnwidth]{../pics/blank.eps}%
\caption{Images of the lab setup during the development process.}%
\label{fig:lab_setup} %
\end{figure}
