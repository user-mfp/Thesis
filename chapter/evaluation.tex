...
\begin{figure}[H]%
\includegraphics[width=\columnwidth]{../pics/groundplan-all.eps}%
...
\\
The visitors imagination and expertise was tested when were shown an image of the remains of the jewel box that is placed by the feet of the princess. The groups were then asked what was in the image. The wood of the jewel box had deterred and only its metal fittings and content, a necklace and fibula, were left.  
\begin{table}[H]
	\centering
	\begin{tabular}{ bl !{\vrule width 1pt} nr }
		\rowstyle{\bfseries}
