...
The main study was conducted from July 23rd to 27th. 
 
\paragraph{Observations} In total, ... 
The distribution of the whole sample is depicted by the scatter plot in Figure \ref{fig:main_study_ages}. 
...
Visitors were distributed over ... 
Figure \ref{fig:main_study_groups} shows the overall group sizes.
...
Visitors were observed and interviewed as a group and not individually ...
\begin{table}[H]
	\centering
	\begin{tabular}{ bl !{\vrule width 1pt} nr }
		\rowstyle{\bfseries}
...
\begin{table}[H]
	...
	\begin{tabular}{ bl !{\vrule width 1pt} nr }
		...
		\toprule
			& 					 \\ 
	\end{tabular}
	\caption{Interaction of visitors with the Haßleben-showcase during the main study.}
...
\begin{table}[H]
	...
	\begin{tabular}{ bl !{\vrule width 1pt} nr }
		...
		\toprule
						& 					 \\
	\end{tabular}
	\caption{Answers to the seventh question of the main study's interview.}
...
\paragraph{Usability Test} \ac{SUS}-Bogen...
