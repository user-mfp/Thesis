...
\caption{[UNFINISHED] Entity-Relationship diagram of the data-strucutre behind an \ac{IMI}-exhibition.}%
...
\begin{figure}[H]%
\includegraphics[width=\columnwidth]{../pics/blank.eps}%
\caption{[UNFINISHED] Schematics of the calculation of the pedal point between two skew lines.}%
...
\begin{figure}[H]%
\includegraphics[width=\columnwidth]{../pics/blank.eps}%
\caption{[UNFINISHED] Schematics of the intersection between a plane and a line.}%
